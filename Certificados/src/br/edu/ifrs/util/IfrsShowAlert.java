...
public class IfrsShowAlert {
    ...
    public void showAlert(JPanel panel, JLabel icone, JLabel label, Boolean ret, String txt) {
        ...
        if (ret == true) {
            icone.setIcon(new ImageIcon(getClass().getResource("/br/edu/ifrs/imagens/check-20.png")));
            ...
            icone.setIcon(new ImageIcon(getClass().getResource("/br/edu/ifrs/imagens/caution-20.png")));
